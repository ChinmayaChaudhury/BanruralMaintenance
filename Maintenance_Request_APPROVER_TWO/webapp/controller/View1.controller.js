sap.ui.define([
	...
	"use strict";
	var dbrNo;
	return Controller.extend("Maintenance_Request_APPROVER_TWO.Maintenance_Request_APPROVER_TWO.controller.View1", {
		onInit: function () {
		...
		handleScreenshotUpload: function (oEvent) {
			...
			if (file === "") {
				...
				fileUploader.setUploadUrl(
					"/Maintenance_Request_APPROVER_TWOMaintenance_Request_APPROVER_TWO/DBR_DOC_UPLOAD/dbrRepoService/docService/Upload/" + dbrNo);
		...
		getAllPics: function (dbrNo) {
			...
			$.ajax({
				...
				url: "/Maintenance_Request_APPROVER_TWOMaintenance_Request_APPROVER_TWO/DBR_DOC_UPLOAD/dbrRepoService/docService/getAllDoc",
		...
		handlePicDelete: function (oEvent) {
			...
			$.ajax({
				...
				url: "/Maintenance_Request_APPROVER_TWOMaintenance_Request_APPROVER_TWO/DBR_DOC_UPLOAD/dbrRepoService/docService/delete/" + id,
