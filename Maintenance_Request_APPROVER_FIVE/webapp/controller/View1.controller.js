sap.ui.define([
	...
	"use strict";
	var dbrNo;
	return Controller.extend("Maintenance_Request_APPROVER_FIVE.Maintenance_Request_APPROVER_FIVE.controller.View1", {
		onInit: function () {
		...
		handleScreenshotUpload: function (oEvent) {
			...
			if (file === "") {
				...
				fileUploader.setUploadUrl(
					"/Maintenance_Request_APPROVER_FIVEMaintenance_Request_APPROVER_FIVE/DBR_DOC_UPLOAD/dbrRepoService/docService/Upload/" + dbrNo
				);
		...
		getAllPics: function (dbrNo) {
			...
			$.ajax({
				...
				url: "/Maintenance_Request_APPROVER_FIVEMaintenance_Request_APPROVER_FIVE/DBR_DOC_UPLOAD/dbrRepoService/docService/getAllDoc",
