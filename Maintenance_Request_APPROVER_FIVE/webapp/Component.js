sap.ui.define([
	...
	"sap/ui/Device",
	"Maintenance_Request_APPROVER_FIVE/Maintenance_Request_APPROVER_FIVE/model/models"
], function (UIComponent, Device, models) {
	"use strict";

	return UIComponent.extend("Maintenance_Request_APPROVER_FIVE.Maintenance_Request_APPROVER_FIVE.Component", {
		...
		init: function () {
			...
			var contextModel = new sap.ui.model.json.JSONModel(
				"/Maintenance_Request_APPROVER_FIVEMaintenance_Request_APPROVER_FIVE/bpmworkflowruntime/v1/task-instances/" + taskId +
				"/context");
		...
		_completeTask: function (taskId, approvalStatus, refreshTask) {
			...
			context.pedro_miguel_approval_status = approvalStatus;
			var data = {
				status: "COMPLETED",
				context: context
			};
			$.ajax({
				url: "/Maintenance_Request_APPROVER_FIVEMaintenance_Request_APPROVER_FIVE/bpmworkflowruntime/v1/task-instances/" + taskId,
				method: "PATCH",
		...
		_fetchToken: function () {
			var token;
			$.ajax({
				url: "/Maintenance_Request_APPROVER_FIVEMaintenance_Request_APPROVER_FIVE/bpmworkflowruntime/v1/xsrf-token",
				method: "GET",
				async: false,
				headers: {
					"X-CSRF-Token": "Fetch"
