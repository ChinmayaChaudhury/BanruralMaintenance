sap.ui.define([
	...
	"sap/ui/Device",
	"Maintenance_Request_APPROVER_EIGHT/Maintenance_Request_APPROVER_EIGHT/model/models"
], function (UIComponent, Device, models) {
	"use strict";

	return UIComponent.extend("Maintenance_Request_APPROVER_EIGHT.Maintenance_Request_APPROVER_EIGHT.Component", {
		...
		init: function () {
			...
			var contextModel = new sap.ui.model.json.JSONModel(
				"/Maintenance_Request_APPROVER_EIGHTMaintenance_Request_APPROVER_EIGHT/bpmworkflowruntime/v1/task-instances/" + taskId +
				"/context");
		...
		_completeTask: function (taskId, approvalStatus, refreshTask) {
			...
			context.pedro_final_approval_status = approvalStatus;
			var data = {
				status: "COMPLETED",
				context: context
			};
			$.ajax({
				url: "/Maintenance_Request_APPROVER_SIXMaintenance_Request_APPROVER_SIX/bpmworkflowruntime/v1/task-instances/" + taskId,
				method: "PATCH",
