sap.ui.define([
	...
	"use strict";
	var dbrNo;
	return Controller.extend("Maintenance_Request_APPROVER_EIGHT.Maintenance_Request_APPROVER_EIGHT.controller.View1", {
		onInit: function () {
		...
		handleScreenshotUpload: function (oEvent) {
			...
			if (file === "") {
				...
				fileUploader.setUploadUrl(
					"/Maintenance_Request_APPROVER_EIGHTMaintenance_Request_APPROVER_EIGHT/DBR_DOC_UPLOAD/dbrRepoService/docService/Upload/" + dbrNo
				);
		...
		getAllPics: function (dbrNo) {
			...
			$.ajax({
				...
				url: "/Maintenance_Request_APPROVER_EIGHTMaintenance_Request_APPROVER_EIGHT/DBR_DOC_UPLOAD/dbrRepoService/docService/getAllDoc",
		...
		handlePicDelete: function (oEvent) {
			...
			$.ajax({
				...
				url: "/Maintenance_Request_APPROVER_EIGHTMaintenance_Request_APPROVER_EIGHT/DBR_DOC_UPLOAD/dbrRepoService/docService/delete/" +
					id,
