sap.ui.define([
	...
	"sap/ui/Device",
	"Maintenance_Request_APPROVER_THREE/Maintenance_Request_APPROVER_THREE/model/models"
], function (UIComponent, Device, models) {
	"use strict";

	return UIComponent.extend("Maintenance_Request_APPROVER_THREE.Maintenance_Request_APPROVER_THREE.Component", {
		...
		init: function () {
			...
			var contextModel = new sap.ui.model.json.JSONModel(
				"/Maintenance_Request_APPROVER_THREEMaintenance_Request_APPROVER_THREE/bpmworkflowruntime/v1/task-instances/" + taskId +
				"/context");
		...
		_completeTask: function (taskId, approvalStatus, refreshTask) {
			...
			context.miguel_approval_status = approvalStatus;
			var data = {
				status: "COMPLETED",
				context: context
			};
			$.ajax({
				url: "/Maintenance_Request_APPROVER_THREEMaintenance_Request_APPROVER_THREE/bpmworkflowruntime/v1/task-instances/" + taskId,
				method: "PATCH",
		...
		_fetchToken: function () {
			var token;
			$.ajax({
				url: "/Maintenance_Request_APPROVER_THREEMaintenance_Request_APPROVER_THREE/bpmworkflowruntime/v1/xsrf-token",
				method: "GET",
				async: false,
				headers: {
					"X-CSRF-Token": "Fetch"
