sap.ui.define([
	...
	"use strict";
	var dbrNo;
	return Controller.extend("Maintenance_Request_APPROVER_ONE.Maintenance_Request_APPROVER_ONE.controller.View1", {
		onInit: function () {
		...
		handleScreenshotUpload: function (oEvent) {
			...
			if (file === "") {
				...
				fileUploader.setUploadUrl(
					"/Maintenance_Request_APPROVER_ONEMaintenance_Request_APPROVER_ONE/DBR_DOC_UPLOAD/dbrRepoService/docService/Upload/" + dbrNo);
		...
		getAllPics: function (dbrNo) {
			...
			$.ajax({
				...
				// /Maintenance_Request_APPROVER_ONEMaintenance_Request_APPROVER_ONE
				url: "/Maintenance_Request_APPROVER_ONEMaintenance_Request_APPROVER_ONE/DBR_DOC_UPLOAD/dbrRepoService/docService/getAllDoc",
		...
		handlePicDelete: function (oEvent) {
			...
			$.ajax({
				...
				url: "/Maintenance_Request_APPROVER_ONEMaintenance_Request_APPROVER_ONE/DBR_DOC_UPLOAD/dbrRepoService/docService/delete/" + id,
