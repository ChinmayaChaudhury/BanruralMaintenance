sap.ui.define([
	...
	"sap/ui/Device",
	"Maintenance_Request_APPROVER_SIX/Maintenance_Request_APPROVER_SIX/model/models"
], function (UIComponent, Device, models) {
	"use strict";

	return UIComponent.extend("Maintenance_Request_APPROVER_SIX.Maintenance_Request_APPROVER_SIX.Component", {
		...
		init: function () {
			...
			var contextModel = new sap.ui.model.json.JSONModel(
				"/Maintenance_Request_APPROVER_SIXMaintenance_Request_APPROVER_SIX/bpmworkflowruntime/v1/task-instances/" + taskId +
				"/context");
